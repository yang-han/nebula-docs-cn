!!! danger "Nebula Graph 内核 2.x 已发布。 Nebula Graph 内核 [1.x](https://github.com/vesoft-inc/nebula) 与 [2.x](https://github.com/vesoft-inc/nebula-graph)数据格式、通信协议、客户端等均双向不兼容，代码仓库不相同。2.x 请参考[新版本文档](https://docs.nebula-graph.com.cn/)。"
